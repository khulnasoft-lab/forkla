...
def forkla_repositories():
    ...
    maybe(
        http_archive,
        name = "JCommander",
        sha256 = "cfabc681e22eb1f09ca9e27ad019bf8f084c8aa75b17dfb49ef36c759823d587",
        urls = [
            "https://github.com/cbeust/jcommander/archive/38acef9b488551dc4931e82520480cc082befe65.zip",
        ],
